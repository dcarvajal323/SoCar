...
HD_PWD='/home/ramsey/SoCar/VivadoProject/SoCar/SoCar.runs/system_pwm_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pwm_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pwm_gen_0_1.tcl
